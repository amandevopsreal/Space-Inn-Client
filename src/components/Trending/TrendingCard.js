            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p style={{ fontSize: "12px", color: "#45666B", fontWeight: "500", letterSpacing: "0", lineHeight: "normal" }} class="card-text mt-2">{upcomingitem.configuration} BHK</p>
                        ...
                        <p style={{ fontSize: "12px", fontWeight: "500", color: "#1A363E", letterSpacing: "0", lineHeight: "normal" }} class="card-text mt-2">{upcomingitem.minPrice} - {upcomingitem.maxPrice}.</p>
                    </div>
                </div>
            </div>
        </div>
